...
def findbggusers(request):
    ...
    return render(request, 'bgg_stats/findbggusers.html', {'search':us})
...
def userstoquery(request):
    ...
    return render(request, 'bgg_stats/userstoquery.html', {'users':users})
...
def getuserratings(request):
    ...
    return render(request, 'bgg_stats/getuserratings.html', {'user':user, 'ratings':ratings})
...
def index(request):
    ...
    return render(request, 'bgg_stats/index.html', {'plays':plays, 'favs':favs, 'bgg_user':settings.BGG_USER, 'weeks': weeks, 'weeks_sum':sum(v['count'] for v in weeks)})