...
class BudgetForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'tax_cocoa':forms.TextInput(attrs={'class':'form-control touchspin-pct'}),
                   'tax_lower':forms.TextInput(attrs={'class':'form-control touchspin-pct'}),
                   'tax_upper':forms.TextInput(attrs={'class':'form-control touchspin-pct'}),
